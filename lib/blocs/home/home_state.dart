...
class HomeState extends Equatable {
  ...
  const HomeState({this.postStatus = PostStatus.loading,this.listTodayTasks = const <Task>[], this.message = ''});

  HomeState copyWith({List<Task>? listTodayTasks,PostStatus? postStatus, String? message }) {
    return HomeState(
