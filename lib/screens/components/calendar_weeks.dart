  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: CalendarWeek(
        ...
        weekendsStyle: TextStyle(color: Colors.red, fontWeight: FontWeight.bold),

        /*Custom MONDAY... FRIDAY*/
        dayOfWeekStyle: TextStyle(fontSize: 10, color: kTextColorBold, fontWeight: FontWeight.bold),
        dayShapeBorder: BoxShape.circle,

        /*Custom pressing*/
        pressedDateBackgroundColor: Colors.blue.withOpacity(0.5),
        pressedDateStyle: TextStyle(fontWeight: FontWeight.bold, color: kTextWhiteColor),

        /*Custom today*/
        todayBackgroundColor: Colors.lightBlue,
        todayDateStyle: TextStyle(color: kTextWhiteColor, fontWeight: FontWeight.bold),
        decorations: [
